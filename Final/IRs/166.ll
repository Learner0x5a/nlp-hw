; ModuleID = 'src/166.src'
source_filename = "src/166.src"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: convergent nofree nounwind uwtable writeonly
define dso_local spir_kernel void @A(double* nocapture %a, double* nocapture %b, double* nocapture %c, double* nocapture %d, i32 %e) local_unnamed_addr #0 !kernel_arg_addr_space !3 !kernel_arg_access_qual !4 !kernel_arg_type !5 !kernel_arg_base_type !5 !kernel_arg_type_qual !6 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  store double 0.000000e+00, double* %arrayidx5, align 8, !tbaa !7
  %arrayidx7 = getelementptr inbounds double, double* %d, i64 %idxprom
  store double 0.000000e+00, double* %arrayidx7, align 8, !tbaa !7
  br label %cleanup
...
!5 = !{!"double*", !"double*", !"double*", !"double*", !"int"}
!6 = !{!"", !"", !"", !"", !""}
!7 = !{!8, !8, i64 0}
!8 = !{!"double", !9, i64 0}
