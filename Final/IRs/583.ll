; ModuleID = 'src/583.src'
source_filename = "src/583.src"
...
for.body.epil:                                    ; preds = %if.end.loopexit.unr-lcssa
  ...
  %12 = load float, float* %arrayidx5.epil, align 4, !tbaa !7
  %arrayidx7.epil = getelementptr inbounds float, float* %b, i64 %indvars.iv.unr
  %13 = load float, float* %arrayidx7.epil, align 4, !tbaa !7
