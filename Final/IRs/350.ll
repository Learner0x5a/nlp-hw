; ModuleID = 'src/350.src'
source_filename = "src/350.src"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: convergent nofree nounwind uwtable
define dso_local spir_kernel void @A(double* nocapture %a, double %b, i32 %c, i32 %d, i32 %e) local_unnamed_addr #0 !kernel_arg_addr_space !3 !kernel_arg_access_qual !4 !kernel_arg_type !5 !kernel_arg_base_type !5 !kernel_arg_type_qual !6 {
entry:
  ...
  %sub8 = add nsw i32 %d, -1
  %cmp9 = icmp slt i32 %conv3, %sub8
  %or.cond = and i1 %cmp, %cmp9
  %sub12 = add nsw i32 %c, -1
  %cmp13 = icmp slt i32 %conv6, %sub12
  %or.cond50 = and i1 %or.cond, %cmp13
  br i1 %or.cond50, label %if.end, label %cleanup
