; ModuleID = 'src/582.src'
source_filename = "src/582.src"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: convergent nofree nounwind uwtable
define dso_local spir_kernel void @A(float* nocapture readonly %a, float* nocapture %b, float* nocapture readonly %c, i32 %d, i32 %e) local_unnamed_addr #0 !kernel_arg_addr_space !3 !kernel_arg_access_qual !4 !kernel_arg_type !5 !kernel_arg_base_type !5 !kernel_arg_type_qual !6 {
entry:
...
for.body.epil:                                    ; preds = %if.end.loopexit.unr-lcssa
  ...
  %16 = load float, float* %arrayidx.epil, align 4, !tbaa !7
  %arrayidx5.epil = getelementptr inbounds float, float* %c, i64 %indvars.iv.unr
  %17 = load float, float* %arrayidx5.epil, align 4, !tbaa !7
  %18 = tail call float @llvm.fmuladd.f32(float %16, float %17, float %.unr)
  store float %18, float* %arrayidx8, align 4, !tbaa !7
  br label %if.end
