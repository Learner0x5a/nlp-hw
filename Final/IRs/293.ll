; ModuleID = 'src/293.src'
source_filename = "src/293.src"
...
if.end:                                           ; preds = %entry
  ...
  %arrayidx68 = getelementptr inbounds [14 x double], [14 x double]* %3, i64 %idxprom, i64 %idxprom11
  store double %mul64, double* %arrayidx68, align 8, !tbaa !7
  %sub71 = add nsw i32 %g, -1
  %idxprom72 = sext i32 %sub71 to i64
  %arrayidx76 = getelementptr inbounds [13 x [13 x [5 x double]]], [13 x [13 x [5 x double]]]* %2, i64 %idxprom, i64 %idxprom72, i64 %idxprom11, i64 4
  %12 = load double, double* %arrayidx76, align 8, !tbaa !7
  %arrayidx84 = getelementptr inbounds [13 x [13 x [5 x double]]], [13 x [13 x [5 x double]]]* %2, i64 %idxprom, i64 %idxprom72, i64 %idxprom11, i64 1
  %13 = load double, double* %arrayidx84, align 8, !tbaa !7
  %arrayidx101 = getelementptr inbounds [13 x [13 x [5 x double]]], [13 x [13 x [5 x double]]]* %2, i64 %idxprom, i64 %idxprom72, i64 %idxprom11, i64 2
  ...
  %arrayidx118 = getelementptr inbounds [13 x [13 x [5 x double]]], [13 x [13 x [5 x double]]]* %2, i64 %idxprom, i64 %idxprom72, i64 %idxprom11, i64 3
  ...
  %arrayidx136 = getelementptr inbounds [13 x [13 x [5 x double]]], [13 x [13 x [5 x double]]]* %2, i64 %idxprom, i64 %idxprom72, i64 %idxprom11, i64 0
  ...
  %arrayidx143 = getelementptr inbounds [14 x double], [14 x double]* %4, i64 %idxprom, i64 %idxprom11
