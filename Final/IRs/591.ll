; ModuleID = 'src/591.src'
source_filename = "src/591.src"
...
land.lhs.true:                                    ; preds = %entry
  %cmp6 = icmp sgt i32 %conv3, %d
  %cmp9 = icmp slt i32 %conv, 1
  %or.cond.not = or i1 %cmp9, %cmp6
  %cmp13 = icmp sgt i32 %conv, %c
  %or.cond27 = or i1 %cmp13, %or.cond.not
  br i1 %or.cond27, label %if.end, label %if.then

if.then:                                          ; preds = %land.lhs.true
  %add12 = add nsw i32 %c, 1
  %idxprom28 = zext i32 %conv to i64
  %arrayidx = getelementptr inbounds float, float* %a, i64 %idxprom28
