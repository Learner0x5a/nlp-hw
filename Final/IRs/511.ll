; ModuleID = 'src/511.src'
source_filename = "src/511.src"
...
if.end:                                           ; preds = %entry
  ...
  %arrayidx17 = getelementptr inbounds [13 x [13 x [5 x double]]], [13 x [13 x [5 x double]]]* %3, i64 %idxprom, i64 %idxprom13, i64 %idxprom15, i64 0
  ...
  %5 = bitcast double* %arrayidx24 to i64*
  ...
  %mul = fmul double %4, %call46
  %add47 = fadd double %8, %9
  %mul48 = fmul double %add47, 5.000000e-01
  %sub = fsub double %8, %9
  %mul50 = fmul double %call46, %sub
  store double %mul50, double* %arrayidx17, align 8, !tbaa !7
  %fneg = fneg double %7
  store double %fneg, double* %arrayidx24, align 8, !tbaa !7
  %10 = bitcast double* %arrayidx31 to i64*
