; ModuleID = 'src/396.src'
source_filename = "src/396.src"
...
if.end:                                           ; preds = %entry
  ...
  %mul618 = add i32 %mul, %conv2
  %add = mul i32 %mul618, %b
  %add8 = add i32 %conv4, %e
  %add9 = add i32 %add8, %add
